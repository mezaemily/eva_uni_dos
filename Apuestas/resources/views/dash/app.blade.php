...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .vs { font-family:var(--mono); font-size:10px; color:var(--muted);
...
<aside class="sidebar">
    ...
    <nav class="s-nav">
        ...
        <div class="s-group">Finanzas</div>
...
<div class="main">
    <header class="topbar">
        ...
        <div class="t-right">
            <div class="t-balance">$ {{ number_format(auth()->user()->balance, 2) }}</div>
